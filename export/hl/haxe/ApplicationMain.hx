...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Unnamed Neural Obstruction", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("Unnamed Neural Obstruction", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "9";
		app.meta["company"] = "InaTheCat";
		app.meta["file"] = "Unnamed Neural Obstruction";
		app.meta["name"] = "Unnamed Neural Obstruction";
		app.meta["packageName"] = "com.example.myapp";
		app.meta["version"] = "0.0.1p";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "Unnamed Neural Obstruction",
			width: 1280,
			x: null,
			y: null,
		};
		...
		#elseif air
		app.window.title = "Unnamed Neural Obstruction";
		#else
