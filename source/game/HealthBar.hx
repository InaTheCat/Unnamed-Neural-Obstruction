...
class HealthBar extends FlxSpriteGroup
{
	...
	/**
	 * @param min da min of da health gng
	 * @param max da max
	 * @param type the sprite of the bg, and thats it
	**/
			...
			dir:FlxBarFillDirection = LEFT_TO_RIGHT, border:Bool = false):Void
	{
		...
		var path:String = Paths.exists('game/hud/$type') ? Paths.image('game/hud/$type') : Paths.image('game/hud/healthBar');
